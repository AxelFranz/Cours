...
#pragma omp single
  {
#pragma omp task depend(in:r1,r2) depend(out:d1)
      d1 = f(r1, r2, 1);
#pragma omp task depend(in:r2,r3) depend(out:d2)
      d2 = f(r2, r3, 1);
#pragma omp task depend(in:d1,d2) depend(out:d3)
      d3 = f(d1, d2, 1);
#pragma omp task depend(in:r1,r3) depend(out:d4)
      d4 = f(r1, r3, 2);
#pragma omp task depend(in:r2,d2) depend(out:d5)
      d5 = f(r2, d2, 1);
