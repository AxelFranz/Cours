...
def scinder(rect,proportion,cote):
    if cote == 1:
        return((rect[0]*proportion,rect[1]),(rect[0]*(1-proportion),rect[1]))
    if cote == 3:
        return ((rect[0]*(1-proportion),rect[1]),(rect[0]*proportion,rect[1]))
    if cote == 0:
        return((rect[0],rect[1]*proportion),(rect[0],rect[1]*(1-proportion)))
    elif cote == 2:
        return((rect[0],rect[1]*(1-proportion)),(rect[0],rect[1]*proportion))
